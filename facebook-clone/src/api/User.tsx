...
export const ApiUser = createApi({
  ...
  endpoints: (builder) => ({
    ...
    //get all user
    getAllUsers: builder.query<any, number>({
    ...
    //update user
    updateUser: builder.mutation<void, Omit<any, 'password' | 'account'>>({
      query: (user) => ({
    ...
    //Upload image user
    upLoadAvartaUser: builder.mutation<any, any>({
      query: (file) => ({
